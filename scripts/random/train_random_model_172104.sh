#!/bin/bash
#SBATCH --job-name=aml3_train_sparse_models_172104
#SBATCH --qos=long
#SBATCH --time=0-5:00
...
#SBATCH --output=/vast/home/jomojola/project/logs/random/train_random_distributed_dst172104_job-%j.out
#SBATCH --array=1-10%1
#SBATCH --requeue
...
poetry run torchrun \
    ...
    -ds 172104 -lr 1e-3 -e 300 -b 1024 -v
rm core*

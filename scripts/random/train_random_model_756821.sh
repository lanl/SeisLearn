#!/bin/bash
#SBATCH --job-name=aml3_train_sparse_models_756821
#SBATCH --qos=long
#SBATCH --time=0-12:00
#SBATCH --mem=100G
#SBATCH --partition=shared-gpu-ampere,shared-redstone,general,shared-gpu
#SBATCH --constraint="gpu_vendor:nvidia&[gpu_count:8]"
#SBATCH --output=/vast/home/jomojola/project/logs/random/train_random_distributed_dst756821_job-%j.out
#SBATCH --array=1-10%1
#SBATCH --requeue
...
poetry run torchrun \
    ...
    -ds 756821 -lr 1e-3 -e 300 -b 1024 -v
rm core*

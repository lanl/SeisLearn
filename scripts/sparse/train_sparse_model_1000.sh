#!/bin/bash
#SBATCH --job-name=aml3_train_sparse_models_1000
#SBATCH --qos=long
#SBATCH --time=0-5:00
...
#SBATCH --output=/vast/home/jomojola/project/logs/sparse/train_sparse_distributed_dst1000_job-%j.out
#SBATCH --array=1-10%1
#SBATCH --requeue
...
poetry run torchrun \
    ...
    -sdm 1000 -lr 1e-3 -e 300 -b 1024 -v
rm core*
